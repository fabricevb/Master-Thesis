...
situation    & respondent 1 & respondent 2           &  BSI & Var(BSI) & EIR & Var(EIR) \\ \hline
 ...
 4 & positive $\rightarrow$ neutral & negative $\rightarrow$ neutral & 0 & 0 & 0 & 1  \\
\end{tabular}
\end{table}
...
\begin{figure}[H]
    ...
    \begin{tikzpicture} \footnotesize
           \draw [thin, black, ->] (0,0) -- (0,4);    % draw y-axis line
            ...
            \node [left] at (0,0.7) {negative};                % label y-intercept
            \node [left] at (0,2) {neutral};                % label y-intercept
            \node [left] at (0,3.3) {positive};                % label y-intercept
