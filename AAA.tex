...
Further explanation including examples to better understand the different new indicators/variables, can be found in Appendix on \autopageref{chap:appendix:explain Var BSI and EIR}
