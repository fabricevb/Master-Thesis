...
It can be seen that for that period (1988-2000), \ref{eq:model2} and \ref{eq:model3} are only slightly better than \ref{eq:model1} for according to most of the statistics.
