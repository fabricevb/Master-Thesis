...
\begin{eqnarray}
    ...
    &=& 1/q ( \pi_{Q1,+} +  \pi_{Q2,+} + \ldots +  \pi_{Qq,+}  -  \pi_{Q1,-} -  \pi_{Q2,-} - \ldots - \pi_{Qq,-} \Large) \nonumber\\
\end{eqnarray}
...
\begin{eqnarray}
    \mbox{ Weighted BSI} &=& \frac{\sum^n_{i=1} \omega_i ( x_{iQ1} + x_{iQ2} +\ldots + x_{iQq})}{q} \\    &=& 1/n ( \pi_{Q1,+} + \Omega_{Q2,+} + \ldots + \Omega_{Qq,+} - \Omega_{Q1,-} - \Omega_{Q2,-} - \ldots - \Omega_{Qq,-} \Large) \nonumber\\
\end{eqnarray}
...
The new indicator, the evolution of individual responses, also has a variance that has some  interesting interpretation. 
...
It's interesting to notice that there is no need for year on year GDP seasonal correction since it's, by definition, eliminating all its seasonality. 
When running the seasonality tests, non of the test show seasonality.
...
Therefore, the linear model is preferred here.
