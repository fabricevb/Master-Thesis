...
Also called the "flash" estimation, nowcasting has increasingly gain importance in the last decade.
it consists in the short term estimation of the economy, mostly the GDP.
it is, as we will see later, a fundamental approach since the business survey indicator is published monthly who are you other indicator's GDP are published quarterly 
the lag between the observation and publication is even greater since the Business Survey Indicator is published only  
