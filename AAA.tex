...
\addplot [thick, black, domain = -1:1] {1 - 0 - x^2};
\addplot [thick, black, domain = -0.95:0.95] {1 - 0.05 - x^2};
\addplot [thick, black, domain = -0.9:0.9] {1 - 0.1 - x^2};
\addplot [thick, black, domain = -0.85:0.85] {1 - 0.15 - x^2};
\addplot [thick, black, domain = -0.8:0.8] {1 - 0.2 - x^2};
\addplot [thick, black, domain = -0.75:0.75] {1 - 0.25 - x^2};
\addplot [thick, black, domain = -0.7:0.7] {1 - 0.3 - x^2};
\addplot [thick, black, domain = -0.65:0.65] {1 - 0.35 - x^2};
\addplot [thick, black, domain = -0.6:0.6] {1 - 0.4 - x^2};
\addplot [thick, black, domain = -0.55:0.55] {1 - 0.45 - x^2};
\addplot [thick, black, domain = -0.5:0.5] {1 - 0.5 - x^2};
\addplot [thick, black, domain = -0.45:0.45] {1 - 0.55 - x^2};
\addplot [thick, black, domain = -0.4:0.4] {1 - 0.6 - x^2};
\addplot [thick, black, domain = -0.35:0.35] {1 - 0.65 - x^2};
\addplot [thick, black, domain = -0.3:0.3] {1 - 0.7 - x^2};
\addplot [thick, black, domain = -0.25:0.25] {1 - 0.75 - x^2};
\addplot [thick, black, domain = -0.2:0.2] {1 - 0.8 - x^2};
\addplot [thick, black, domain = -0.15:0.15] {1 - 0.85 - x^2};
\addplot [thick, black, domain = -0.1:0.1] {1 - 0.9 - x^2};
\addplot [thick, black, domain = -0.05:0.05] {1 - 0.95 - x^2};
\addplot [thick, black, domain = -0.01:0.01] {1 - 0.99 - x^2};
\end{axis}
\end{tikzpicture}
