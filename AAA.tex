...
This chapter is a presentation of the Belgian 
Business Survey Indicator also referred to as the Business Survey Barometer or Business confidence barometer.
...
Without going to much into details. The selections of new participants is done by "waves" when the department responsible for the Business Survey at the NBB decides that there aren't enough participants in a specific sector anymore. 
...
- test for seasonality (see appendix \autopageref{sec:test for seasonality})



\subsubsection{Seasonal correction of the Indicator}

\subsubsection{Seasonal correction of the Variance}

\subsubsection{Seasonal correction of the Indicator of the Evolution}

\subsubsection{Seasonal correction of the Variance of Z}
...
\begin{landscape}
    \begin{table}[H] 
    \centering 
    \small %\tiny \scriptsize \footnotesize 
  \caption{} 
%  \label{} 
