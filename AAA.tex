...
%It was shown as been quite unstable but with
...
De variantie van de conjunctuurenquête-indicator (BSI), een nieuwe indicator die de evolutie van de individuele antwoorden (EIA) en de variantie ervan wordt genoemd.
...
In de context van de conjunctuurenquête heeft de indicator een variantie die geïnterpreteerd kan worden als de (on)overeenstemming tussen de respondenten.
In de context van de conjunctuurenquête zijn de gegevens trichonoom, aangezien er slechts drie mogelijke antwoorden op de vragen van de enquête zijn. Dit komt met interessante eigenschappen als de gemiddelde-variantie relatie en het feit dat de variantie tussen 0 en 1 begrensd is.
...
Hier wordt een maatregel voorgesteld, de evolutie van de individuele antwoorden, die rekening houdt met de veranderingen in de antwoorden van alle deelnemers.
...
where 
$E(X_{Q1})$, $E(X_{Q2})$, $E(X_{Q3})$ and $E(X_{Q4})$ are the different averages for question 18, 27, 32 and 33 (weighted or unweighted).
