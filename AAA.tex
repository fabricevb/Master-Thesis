...
\begin{figure}[htp!]
    ...
    \begin{tikzpicture}
        ...
        \end{axis}
    \end{tikzpicture}
    \caption{Business cycles from 1975 to 2009 of the American Economy according to the NBER(cite)}
    \label{fig:NBER BS}
\end{figure}
...
The variance shows here an interest that can be surprising since it help to better understand the survey and the behaviour of respondents. 
...
Var(BSI) and Var(EIR) can measure the excitement among respondents

!!!!!

It would be very interesting to dive more into these issues, but this will be left for further research. 
In the context of this paper, it's important to notice the potential importance of attrition and dropout and the importance of the different variances a hand ?????to account for it.
...
Descriptive statistics can be seen in \autoref{tab:descriptive stats}.
...
%    \captionsetup{justification=centering}
    ...
    \caption{Plot of the different time series}
...
F Statistic & \multicolumn{1}{c}{143.463$^{***}$} & \multicolumn{1}{c}{147.283$^{***}$} & \multicolumn{1}{c}{79.773$^{***}$} & \multicolumn{1}{c}{73.079$^{***}$} & \multicolumn{1}{c}{73.590$^{***}$} \\ 
\hline 
\hline \\[-1.8ex] 
...
\section*{Questions taken into account for the calculation of the industry business survey (NS975)}
