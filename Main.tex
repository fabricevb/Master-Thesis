...
where $\sum_{i=1}^{n} \omega_i = 1 $. In other words, the specific weight for each company takes two weighting procedures into account, a weight specific to the size of the company, and a weight specific to the sub-sector 
...
Where $\Delta \omega_i$ is the difference between the previous 
...
\subsubsection{Indicator \& Questions}
...
Before modelling the data, it's important to look at the different effects that could mislead the outcome of the analysis. After exploring the data and a literature review, four main effects where found as potential sources of bias. 
One is due to external effects; seasonal effects
while three are due to the survey structure and organisation.
