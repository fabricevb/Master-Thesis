...
The seasonal-irregular (S-I) ratio charts, which can be seen in the appendix on \autopageref{fig:S-I seasonal correction RJDemetra}, are interesting to look at to better understand the seasonal effect influencing the different variables.
