...
# Import all datasets
MI018 <-read_excel("Y:/TRICONAT/EMOS/Stage2018/Datasets/RS_975.xlsx",
                   sheet="MI018")

MI027 <-read_excel("Y:/TRICONAT/EMOS/Stage2018/Datasets/RS_975.xlsx",
                   sheet="MI027")

MI032 <-read_excel("Y:/TRICONAT/EMOS/Stage2018/Datasets/RS_975.xlsx",
                   sheet="MI032")

MI033 <-read_excel("Y:/TRICONAT/EMOS/Stage2018/Datasets/RS_975.xlsx",
                   sheet="MI033")

GDP <- read_excel("Y:/TRICONAT/EMOS/Stage2018/Datasets/GDP.xlsx",
                  sheet="All")
...
period <- as.Date(MI018$period, format = "%B %d, %Y")
...
MI018_E_model_ts <- tramoseats_def(MI018_E) 
MI027_E_model_ts <- tramoseats_def(MI027_E) 
MI032_E_model_ts <- tramoseats_def(MI032_E) 
MI033_E_model_ts <- tramoseats_def(MI033_E) 
...
# add variable of GDP
GDP$period <- as.Date(GDP$period, format = "%B %d, %Y")
