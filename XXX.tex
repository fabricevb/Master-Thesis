...
%\begin{eqnarray}
    %\Var \left(\sum_{i=1}^{q} Z_{i}\right) = \sum_{i=1}^{q} \sum_{j=1}^{q} \Cov\left(Z_{i}, Z_{j}\right) = \sum_{i=1}^{q} \Var\left(Z_{i}\right)+2 \sum_{1 \leq i<j \leq q} \Cov\left(Z_{i}, Z_{j}\right) \\ \nonumber
%\end{eqnarray} 
